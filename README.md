...
class GianMiranda extends Developer {
  ...
  final gpa = "3.70 / 4.00";
  final majorGpa = "4.00 / 4.00";

  final currentlyBuilding = [
    "Cross-platform Flutter apps",
    "Firebase-backed product features",
    "Energy-efficient CNN research",
  ];

  String funFact() => "My debugging journey began with robots crashing into walls.";
}
```
...
- Analytical dashboards and admin workflows
- Full-stack, mobile-first web products
- CNN experiments for efficient AI systems
...
> A cross-platform tournament engine built for pickleball events inside the MiUni mobile application.

| Quest Stat | Result |
| :--- | :--- |
| **Toolkit** | Flutter · Dart · Firebase · Git · GitHub |
| **Platforms** | iOS · Android · iPadOS |
| **Challenge** | Model match flow, round progression, edge cases, and tournament scenarios |
| **Power-Up** | Iterative testing, responsive layouts, and real-time Firebase data |
| **Outcome** | A more reliable and organized sports-event workflow |
| **Code** | Private company project at FT Innovations LLC |
...
> A Flutter app that helps users browse adoptable pets and connect with shelters through a friendly mobile experience.

| Quest Stat | Result |
| :--- | :--- |
| **Toolkit** | Flutter · Dart · Firebase · BLoC |
...
> Machine learning research focused on making CNN-based image processing systems more power- and energy-efficient.

| Quest Stat | Result |
| :--- | :--- |
| **Toolkit** | Python · Jupyter Notebook · CNNs · Machine Learning |
| **Research** | Power- and energy-efficient image processing |
...
> A colorful, mobile-first ordering platform that guides customers through cake discovery and configuration.

| Quest Stat | Result |
| :--- | :--- |
| **Toolkit** | Next.js · React · TypeScript · Firebase |
| **Experience** | Five-step ordering wizard, exact search, and admin dashboard |
